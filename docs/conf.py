...
"""
courses documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'cookiecutter_courses',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/cookiecutter_courses",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'cookiecutter_courses'),
                os.path.join(root_path, 'cookiecutter_courses/migrations')])
