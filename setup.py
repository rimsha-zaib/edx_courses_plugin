#!/usr/bin/env python
"""
Package metadata for cookiecutter_courses.
"""
import os
import re
import sys
...
VERSION = get_version('cookiecutter_courses', '__init__.py')
...
setup(
    ...
    url='https://github.com/openedx/cookiecutter_courses',
    packages=find_packages(
        include=['cookiecutter_courses', 'cookiecutter_courses.*'],
        exclude=["*tests"],
    ),
